...
== Wie buddeln tiefer
// #todo[
//   Hier Abschnitt dazu, dass wir zuerst überlegt hatten, Änderungen im CRDT selbst als draft zu markieren. Das würde Rechenleistung sparen, weil der Sender selbst nur seine eigenen Änderungen ausprobieren muss.
//   Es erhöht allerdings die Komplexität dramatisch, wenn man einen konsistenen Zustand erreichen möchte und vor allem ist es dann seh schwer, das Dokument wieder zum Kompilieren zu bekommen, wenn ein lokaler Fehler durch jemand anderen korrigiert wurde.
// ]

Wir haben einen Editor! Aber als wir da zu mehreren drin herum getippt haben, ist uns ziemlich schnell ein relativ großes Problem in unserem Konzept aufgefallen:
