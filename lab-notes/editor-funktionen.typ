...
Mit Änderungsvorschlägen meinen wir das, was man aus Google Docs oder Word kennt: Man schreibt in ein fremdes Dokument, die Änderung ist für alle sichtbar, wird aber erst dann Teil des eigentlichen Dokuments, wenn jemand sie annimmt.
...
Auch bei Kommentaren könnte man sowas ausprobieren: Sie könnten ebenfalls Teil des normalen CRDTs sein. Ein Kommentar hätte dann zwei Parents, jeweils für Anfang und Ende der kommentierten Stelle, sodass er an den Zeichen hängt und nicht an einer Position im Text -- was auch dann noch funktioniert, wenn davor jemand einen Absatz einfügt. Im Endeffekt wären die Zeichen des Kommentars also Teil des ganz normalen Textflusses, sie hätten nur eine spezielle Markierung. Das könnte auch UX-mäßig interessant sein: Man sieht auch Kommentaren live beim Tippen zu.
